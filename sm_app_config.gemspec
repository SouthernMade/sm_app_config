...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Application configuration for multiple environments."
  spec.description = "Library for managing application configuration using a YAML file or ENV variables."
